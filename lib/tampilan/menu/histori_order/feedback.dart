...
class _feedback_menuState extends State<feedback_menu> {
  ...
  void _insertDatafeedback() async {
    ...
    final url = Uri.parse(
        'http://103.27.206.23/gocraneapp_v2/production/api_gocraneapp/feedback_user.php'); // Ganti dengan URL endpoint API Anda
    try {
  ...
  Future Feedbac_cek() async {
    final Response = await http.post(
        Uri.parse(
            "http://103.27.206.23/gocraneapp_v2/production/api_gocraneapp/feedback_cek.php"),
        body: {
          "transaksi_id": widget.id_reg,
        });
