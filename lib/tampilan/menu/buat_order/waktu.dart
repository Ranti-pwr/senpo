...
class _formwaktuState extends State<formwaktu> {
  ...
  //       Uri.parse("http://103.27.206.23/richzspot/user/getData/$id_user"));
  ...
  //         'POST',
  //         Uri.parse(
  //             'http://103.27.206.23/richzspot/user/updateData/$id_user'));
  ...
  Future<void> td_awal() async {
    final response = await http.get(
      Uri.parse(
          "http://103.27.206.23/gocraneapp_v2/production/buat_order/waktu-order.php?awal=1&tanggal=$datatglawal"),
    );
  ...
  Future<void> td_akhir() async {
    final response = await http.get(
      Uri.parse(
          "http://103.27.206.23/gocraneapp_v2/production/buat_order/waktu-order.php?akhir=1&tanggal=$datatglakhir"),
    );
  ...
  Future alber_list() async {
    final Response = await http.post(
      Uri.parse("http://103.27.206.23/api_gocrane_v3/alber.php"),
    );
    if (this.mounted) {
      this.setState(() {
  ...
  Future<void> bagian_pilih() async {
    final response = await http.get(
      Uri.parse(
          "http://103.27.206.23/gocraneapp_v2/production/buat_order/bagian.php?id=$dp_id"),
    );
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //       //       //     });
        //       //       //   },
        //       //       //   items: startTimeList.map((String? value) {
        ...
        //                         .headline4
        //                         .color),
        //                 semanticsLabel: "Pilih Jam",
        //               ),
        //               value: jamakhir,
        //               items: endTimeList.map((item) {
        //                 return DropdownMenuItem(
        //                   child: Text(
        //                     item['jam'],
        //                     style: TextStyle(
        ...
        //             //     hint: Text('Jam Akhir'),
        //             //     items: endTimeList.map((String? value) {
        //             //       return DropdownMenuItem<String?>(
        //             //         value: value,
        //             //         child: Text(value),
        //             //       );
