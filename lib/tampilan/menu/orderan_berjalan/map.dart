...
class _GoogleMapScreenState extends State<GoogleMapScreen> {
  ...
  //       'http://103.27.206.23/gocraneapp_v2/production/order_berjalan/assets/icon/CRN25_OFF.png'); // Ganti URL_GAMBAR_ICON dengan URL gambar ikon Anda
