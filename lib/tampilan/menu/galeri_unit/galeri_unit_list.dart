...
import 'package:gocrane_v3_new/tampilan/menu/galeri_unit/detail_unit.dart';
...
class galeriunitlist extends StatefulWidget {
  @override
  _galeriunitlistState createState() => _galeriunitlistState();
}

class _galeriunitlistState extends State<galeriunitlist>
  ...
  Future ambildata() async {
    if (this.mounted) {
      ...
      final Response = await http.get(
        Uri.parse(
            "http://103.27.206.23/richzspot/AbsenTunjangan/getAbsenTunjangan/$id_user"),
      );
  ...
  Future lihatDetailOrder() async {
    ...
    //     Uri.parse("http://103.27.206.23/api_gocrane_v3/data_unit.php"),
    //     body: {"paht": "AU"});
